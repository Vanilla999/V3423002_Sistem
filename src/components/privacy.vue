...
<template>
  <section
    class="flex flex-col p-24 w-full bg-gray-200 items-center text-base text-center text-gray-800 mx-auto"
  >
    <h1
      class="text-6xl max-md:px-5 max-md:max-w-full font-bold tracking-tighter leading-none"
    >
      Privacy Policy
    </h1>
    <h2
      class="text-xl mt-4 max-md:px-5 max-md:max-w-full text-zinc-500 tracking-tighter leading-none"
    >
      Last Updated on 27th January 2022
    </h2>
  </section>

  <section class="flex flex-col px-32 mt-32 text-base mx-64">
    <div class="px-auto">
      <h1 class="text-black-500 font-bold text-3xl">
        Lorem ipsum dolor sit amet
      </h1>
      <h2 class="text-gray-500 mt-4">
      ...
      <h3 class="text-black-500 font-bold text-3xl mt-4">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
        tempor.
      </h3>
      <h4 class="text-gray-500 mt-4">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
